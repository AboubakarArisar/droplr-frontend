  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-[#0f172a] to-[#1e293b] text-white px-6 py-10 flex items-center justify-center'>
      <div className='grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl w-full'>
        <div className='bg-[#1e293b] border border-gray-700 rounded-2xl p-6 shadow-lg flex flex-col items-center justify-center text-white transition-all w-full'>
          ...
          {uploading && (
            <div className='w-full mb-3'>
              ...
              <p className='text-sm text-center mt-1 text-blue-400'>
                {progress}%
              </p>
            </div>
          )}
          <button
            ...
            className='bg-blue-600 hover:bg-blue-700 disabled:bg-gray-600 text-white px-6 py-2 rounded-lg transition duration-200 w-full text-center'
          >
            {uploading ? "Uploading..." : "Upload File"}
          </button>
        </div>

        <div className='bg-[#1e293b] border border-gray-700 rounded-2xl p-6 shadow-lg text-white w-full'>
